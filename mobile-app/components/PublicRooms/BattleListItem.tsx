...
const BattleListItem = ({ battle, onSelect = () => {} }: Props) => {
  return (
    <View className="flex-row w-full h-15 border-2 border-border justify-between items-center py-2 my-1 px-2">
      <View className="flex-col gap-1">
        ...
        <View className="flex-row gap-2 items-center">
          ...
          <Text className="font-mono text-xs color-white/35">(1/2)</Text>
        </View>
      </View>
